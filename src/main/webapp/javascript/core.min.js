! function(s) {
    ...
    s.fn.menumaker = function(t) {
        ...
        function u(t) {
            ...
            }(t.find("i").eq(0), t, i, o), m(s.find("i").eq(0), s, i, o)) : t.parents(".banner-headline").hasClass("clip") ? t.parents(".banner-words-wrapper").animate({
                width: "2px"
            }, p, function() {
                _(t, s), f(s)
        ...
        function f(t, e) {
            t.parents(".banner-headline").hasClass("type") ? (m(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".banner-headline").hasClass("clip") && t.parents(".banner-words-wrapper").animate({
                width: t.width() + 10
            }, p, function() {
                setTimeout(function() {
                    u(t)
    ...
    function(f, o, t, m) {
        ...
        h.prototype = {
            ...
            _repositionElements: function() {
                var t, e, i, s, o, n, r, a, l, h, c = this._getScrollLeft(),
    ...
    function(t) {
        ...
        t.prototype = {
            ...
            return "string" == typeof t ? "open" === t ? (e = a ? o.data("magnificPopup") : o[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, s = e.items ? e.items[i] : (s = o, e.delegate && (s = s.find(e.delegate)), s.eq(i)), f._openClick({
                mfpEl: s
            }, o, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = h.extend(!0, {}, t), a ? o.data("magnificPopup", t) : o[0].magnificPopup = t, f.addGroup(o, t)), o
        };
